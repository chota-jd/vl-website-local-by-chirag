        ...
        <div className="space-y-32">
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
              <div className="bg-obsidian-900 p-12 md:p-20 text-white">
                 <h4 className="text-accent text-xs font-black uppercase tracking-ultra mb-10">Phase 01: Auditing</h4>
              ...
              <div className="bg-slate-50 p-12 md:p-20 border border-slate-100">
                 <h4 className="text-accent text-xs font-black uppercase tracking-ultra mb-10">Phase 02: Building</h4>
           ...
           <div className="text-center py-20 border-y border-slate-100">
              <h2 className="text-accent text-xs font-black uppercase tracking-ultra mb-8">Executive Engagement</h2>
              ...
              <Link href="/enquiry" className="inline-flex items-center space-x-4 px-14 py-7 bg-obsidian-900 text-white text-xs font-black uppercase tracking-ultra hover:bg-accent transition-all duration-300 shadow-xl mx-auto group">
